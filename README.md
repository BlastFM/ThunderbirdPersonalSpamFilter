...
![Extension Version](https://img.shields.io/badge/version-1.4.21-blue.svg)
...
**v1.4.21 is the current stable release**, verified to automatically scan and correctly route new messages (including those arriving in the Junk folder) and to restore manual "Mark as Spam (Train AI)" / "Mark as Not Spam" actions on current Thunderbird MV3 builds. It also feeds the Detected Spam Log back into future AI classification, alongside the existing AI Training Memory (Not Spam) examples.
...
Filename: openai-spam-detector-v1.4.21.xpi
### SHA-256: `AB0B87BE25BF1D3946662060182B7212EC290308036C081C90F1369A128BDFC0`
...
[![Download Release](https://img.shields.io/badge/Download-v1.4.21_.XPI-blue?style=for-the-badge&logo=thunderbird&logoColor=white)](https://github.com/BlastFM/ThunderbirdPersonalSpamFilter/releases/download/v1.4.21/openai-spam-detector-v1.4.21.xpi)
...
| :--- | :--- | :--- |
| **Extension Binary** | Ready-to-install Thunderbird Add-on | [`openai-spam-detector-v1.4.21.xpi`](https://github.com/BlastFM/ThunderbirdPersonalSpamFilter/releases/download/v1.4.21/openai-spam-detector-v1.4.21.xpi) |
| **Source Code** | Compressed source files (`.zip`) | [`Source code (zip)`](https://github.com/BlastFM/ThunderbirdPersonalSpamFilter/archive/refs/tags/v1.4.21.zip) |
...
2. Click the extension download button above to save **`openai-spam-detector-v1.4.21.xpi`**.
...
├── README.md
├── openai-spam-detector-v1.4.21.xpi
├── icons/
│   ├── icon-16.png
│   ├── icon-32.png
│   ├── icon-48.png
