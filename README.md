...
![Extension Version](https://img.shields.io/badge/version-1.4.7-blue.svg)
...
**v1.4.7 is the current stable release**, verified to automatically scan and correctly route new messages (including those arriving in the Junk folder) and to restore manual "Mark as Spam (Train AI)" / "Mark as Not Spam" actions on current Thunderbird MV3 builds. It also disables the "Export backup" button when there is no spam log or training memory to export.
...
Filename: openai-spam-detector-v1.4.7.xpi
### SHA-256: `B9D30EF4F847F84005DEE8B57304EAAE2BFEC426D67B2B8A74289FEA376139E3`
...
[![Download Release](https://img.shields.io/badge/Download-v1.4.7_.XPI-blue?style=for-the-badge&logo=thunderbird&logoColor=white)](https://github.com/BlastFM/ThunderbirdPersonalSpamFilter/releases/download/v1.4.7/openai-spam-detector-v1.4.7.xpi)
...
| :--- | :--- | :--- |
| **Extension Binary** | Ready-to-install Thunderbird Add-on | [`openai-spam-detector-v1.4.7.xpi`](https://github.com/BlastFM/ThunderbirdPersonalSpamFilter/releases/download/v1.4.7/openai-spam-detector-v1.4.7.xpi) |
| **Source Code** | Compressed source files (`.zip`) | [`Source code (zip)`](https://github.com/BlastFM/ThunderbirdPersonalSpamFilter/archive/refs/tags/v1.4.7.zip) |
...
2. Click the extension download button above to save **`openai-spam-detector-v1.4.7.xpi`**.
...
├── README.md
├── openai-spam-detector-v1.4.7.xpi
├── icons/
│   ├── icon-48.png
│   ├── icon.png
